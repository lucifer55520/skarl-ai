...
client = None
if not client or GROQ_API_KEY == "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":
    try:
        # The client now pulls directly from the variable above
        client = AsyncGroq(api_key= "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")
